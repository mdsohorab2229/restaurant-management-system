...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="hold-transition skin-red sidebar-mini">
        <div id="dt-App" class="wrapper">
            ...
            @elseif(Auth::user()->canDo(['manage_cash']))
                @include('partials.cashier-navigation')

            @elseif(Auth::user()->canDo('manage_jannat'))
            @include('partials.jannat-navigation')
            
            @elseif(Auth::user()->canDo('manage_store'))
