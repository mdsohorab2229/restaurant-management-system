...
<div id="invoice-POS">
    ...
    <center id="top">
        ...
        <div class="right_content">
            ...
            <p class="customp">Date :- {{$billings->created_at}}</p>
        </div>
        ...
        <div id="table">
            <table>
                ...
                <tr class="tabletitle">
                    ...
                    <td class="payment"><h2>{{$orders->discount}}</h2></td>
                </tr>

                <tr class="tabletitle">
                    <td colspan="2"></td>
                    <td class="Rate"><h2>Payable</h2></td>
                    <td class="payment"><h2>{{$orders->amount - $orders->discount}}</h2></td>
                </tr>

                <tr class="tabletitle">
                    <td colspan="2"></td>
                    <td class="Rate"><h2>Paid</h2></td>
                    <td class="payment"><h2>{{$billings->deposit}}</h2></td>
                </tr>
                
                <tr class="tabletitle">
                    <td colspan="2"></td>
                    <td class="Rate"><h2>Due</h2></td>
                    <td class="payment"><h2>{{$billings->due}}</h2></td>
                </tr>
