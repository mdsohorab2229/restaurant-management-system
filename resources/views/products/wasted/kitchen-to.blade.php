<div class="modal fade" id="send_kitchen_to_wasted">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => 'product.wasted.kitchen-stock', 'method' => 'post']) !!}
            {{ csrf_field() }}
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" onclick="submit_form(this, event)">Send to Wasted Stock</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
