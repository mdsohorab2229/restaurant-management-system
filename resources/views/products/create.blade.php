    ...
    <div class="jrr-class">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Add New Row Materials</h3>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('product_category', makeDropDown($categories), $setting->category_id, ["class" => "form-control", "id" => "category_list"])!!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('brand', makeDropDown($brands), $setting->brand_id, ["class" => "form-control", "id" => "brand_list"])!!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('supplier', makeDropDown($suppliers), $setting->supplier_id, ["class" => "form-control", "id" => "supplier_list"])!!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('unit', makeDropDown($units), null, ["class" => "form-control", "id" => "unit_list"])!!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="cost" class="form-control" id="cost" placeholder="Enter cost per unit" id="">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-success" onclick="submit_form(this, event)">Add Product</button>
            </div>
            {!! Form::close() !!}
        </div>
