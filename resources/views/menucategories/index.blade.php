...
@section('content')
    <div class="jrr-class">
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                <table class="table table-bordered" id="menuCategoryTable">
                    <thead>
                        <tr class="bg-gray">
                            <th>#</th>
                            <th>Name</th>
                ...
                @include('menucategories.create')
                @include('menucategories.edit')
            </div>
