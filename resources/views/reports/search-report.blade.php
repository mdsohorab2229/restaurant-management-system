            ...
            <div class="box-body">
                <div class="table">
                    <div class="table-cell">
                        <div class="row">
                            {!! Form::open(['route' => 'report.kitchen', 'method' => 'get']) !!}
                                {{ csrf_field() }}
                                <div class="col-md-2">
                                    <input type="text" name="from_date" class="form-control date-picker" placeholder="From Date" autocomplete="off" value="{{ $form_date }}">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" name="to_date" class="form-control date-picker" placeholder="To Date"  autocomplete="off" value="{{ $to_date }}">
                                </div>
                                <div class="col-md-2">
                    ...
                    @if($orders)
                        @foreach($orders as $key => $order)
                            <tr>
                                ...
                                <td>{{ $order->chief ? $order->chief->name : "-" }}</td>
