<div class="modal fade" id="edit_modal"  data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!! Form::open(['route' => 'customer.update', 'method' => 'POST']) !!}
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="customer_id" id="customer_hidden_id" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                                    <div class="form-group">
                                <label for="name">Phone</label>
                                <input type="tel" maxlength="11" name="phone" id="phone" placeholder="Enter customer phone" class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="text" name="address" id="address" placeholder="Enter customer address" class="form-control">
